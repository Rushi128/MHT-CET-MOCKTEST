...
<body style="background-color: rgb(247, 244, 240);">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fs-5 text-center">                    
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="Students_Result">EXAM RESULTS</a></li>          
              <li><hr class="dropdown-divider"></li>                            
            </ul>
          </li>         
        </ul>      
  ...
  <div  style="width: 300px;height: auto;background-color:white; padding-top: px;border-radius: 25px; ">
    ...
    <div>
    <form action="Students_Show_Result" method="POST" enctype="multipart/form-data" class="form">                    
...
<div ><br><br>
<button class="btn" style="background-color:green;border-radius:20px;"><a href="stud_show_result.php?email=<?php //echo $mail; ?>" style="color:white;">Proceed</a>
</button></div></div>
<?php
// }
