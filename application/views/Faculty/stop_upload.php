...
<body style="background-color: rgb(247, 244, 240);">
  ...
  <div style="text-align:center;color:green"><h1 style="text-align:center;">Exam has been stopped successfully</h1>
    <?php
    // include("config.php");
    // $ex_id = $_GET['exam_id'];
    
    // $query = mysqli_query($con, "UPDATE exam set exam_status='inactive' where exam_id=$ex_id");
    // if($query)
    // {
    //     $alert = "<script>alert('Exam has been stoped successfully');</script>";
    //     echo $alert;        
    // }
    ?>
