        ...
        <table>
          <thead>
            <tr>
              ...
              <th style="font-size:20px">Exam Status</th>
              <th colspan="4" style="font-size:20px;text-align:center">Action</th>
            </tr>
          </thead>
          ...
          <?php
            ...
            <tr>
                ...
                <td> <a href="<?php echo base_url('FacultyUpload/'.$row->exam_id) ?>"> <img src="assets/images/file.png" alt=""> </a></td>                 
                <td> <a href="<?php echo base_url('FacultyStopup/'.$row->exam_id) ?>"> <img src="assets/images/stop.png" alt=""> </a></td>
                <td> <a href="<?php echo base_url('FacultyManSel/'.$row->exam_id) ?>"> <img src="assets/images/manage.png" alt=""> </a></td>
                <td> <a href="<?php echo base_url('FacultyDelExam/'.$row->exam_id) ?>"> <img src="assets/images/trash.png" alt=""> </a></td>
            </tr>  
            <?php     
            }
